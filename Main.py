...
root = tk.Tk()
root.title("Maternity Pain Detection System")
...
lbl = tk.Label(root, text="Maternity Risk Detection System", font=('times', 35,' bold '), height=1, width=62,bg="#152238",fg="white")
lbl.place(x=0, y=0)
# _+++++++++++++++++++++++++++++++++++++++++++++++++++++++

def Model_Training():
    data = pd.read_csv("database_csv_files/Data1.csv")
    data.head()
    data = data.dropna()
    ...
    dump (svcclassifier,"model_train_data/svm.joblib")
...
def Model_Training1():
    ...
    dump(rf_classifier, "model_train_data/random_forest.joblib")
...
next = tk.Button(root, text="Next", command=disease, width=15, height=2, font=('times', 15, ' bold '),bg="red",fg="white")
